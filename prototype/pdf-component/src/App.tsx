      ...
      <>
        {highlights.length && !isRedactionComplete && (
          <div
            ...
            style={{
              width: (this.containerRef.current?.clientWidth ?? 0) - 2,
            }}
          >
            ...
            {(pdfDocument) => (
              <PdfHighlighter
                ...
                enableAreaSelection={(event) => {
                  return (event.target as HTMLElement).className === "textLayer" //event.altKey;
                }}
